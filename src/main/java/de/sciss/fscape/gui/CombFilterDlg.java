...
//		[1 0 0 0 0 0 0 .... 0 -1] and A=[1 0 0 0 .... 0 -.1]
	...
	topLevel:
        ...
        // .... check running ....
            ...
            quality		= (float) (Param.transform( pr.para[ PR_QUALITY ],Param.ABS_AMP, ampRef, null )).value;
            delay		= (int) (inStream.rate / pr.para[ PR_FREQ ].value + 0.5);
            if( (delay == 0) || (pr.para[ PR_FREQ ].value == 0.0) ) throw new IOException( ERR_FREQ );
