...
topLevel: try {
        ...
        // .... check running ....
            ...
            lpOrder			= (int) pr.para[ PR_LPORDER ].value;
            d1				= Param.transform( pr.para[ PR_STEPSIZE ], Param.ABS_MS, null, null ).value;
            ...
            d1				= Param.transform( pr.para[ PR_CALCLEN ], Param.ABS_MS, null, null ).value;
