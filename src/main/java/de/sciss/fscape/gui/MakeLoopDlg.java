...
topLevel: try {
		// ---- open input, output; init ----
			...
			fadeLen		= (long) (AudioFileDescr.millisToSamples( inDescr, Param.transform( pr.para[ PR_FADELENGTH ], Param.ABS_MS, ref, null ).val ) + 0.5);
...
//System.err.println( "copyOff = "+copyOff+"; fadeInOff = "+fadeInOff+"; fadeOutOff = "+fadeOutOff+"; copyLen = "+copyLen );
			...
			if( pr.intg[ PR_GAINTYPE ] == GAIN_UNITY ) {
				...
				gain		= (float) (Param.transform( pr.para[ PR_GAIN ], Param.ABS_AMP, ref, null )).val;
				outF2		= outF;
			}
		// .... check running ....
