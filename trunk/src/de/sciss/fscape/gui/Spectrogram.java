 ...
 *	patcher, will output the current sonagramme,
...
// -------- private Variablen --------
	...
	private int			x		= 0;
	private int[]		xTime;				// Zeitpunkt, den ein Pixel repräsentiert
	private int			zoom	= 0;		// 2^n vergrößert
...
//		gui.setFont( Main.getFont( Main.FONT_GUI ));
	...
	public void addFrame( SpectFrame fr )
	{
		...
		synchronized( this ) {
			...
			if( lines < height ) {				// nicht benutzten Raum löschen
				imgG.setColor( Color.black );
...
// -------- MouseMotion Listener Methoden (spectPanel) --------
