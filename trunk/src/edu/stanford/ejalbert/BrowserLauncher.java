...
public class BrowserLauncher {
	 ...
	 */
	private BrowserLauncher() { /* nothing */}
		...
		switch (jvm) {
			case MRJ_2_0:
				...
				try {
					...
					putParameter.invoke(br, new Object[] { keyDirectObject, aeDesc });
					sendNoReply.invoke(br, new Object[] { });
				} catch (InvocationTargetException ite) {
				...
				break;
			case MRJ_2_1:
				Runtime.getRuntime().exec(new String[] { (String) br, url } );
				break;
			case MRJ_3_0:
		    ...
		    case WINDOWS_9x:
		    	...
		    	// characters to work.
				Process process = Runtime.getRuntime().exec(new String[] { (String) br,
			...
			case OTHER:
				...
				process = Runtime.getRuntime().exec(new String[] { (String) br,
